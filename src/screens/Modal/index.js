    ...
    return (
        <View style={tw.style("flex-1 items-center pt-1")}>
            ...
            <TouchableOpacity
                ...
                style={tw.style("w-64 p-3 rounded-xl absolute bottom-10 bg-red-400",incompleteForm && "bg-gray-400")}
                onPress={()=>updateUserProfile()}>
                <Text style={tw.style("text-center text-white text-xl")}>Update Profile</Text>
            </TouchableOpacity>
        </View>
    );
}
